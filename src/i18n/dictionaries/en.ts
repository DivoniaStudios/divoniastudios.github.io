...
export const en: Dictionary = {
  ...
  contactPage: {
    ...
    form: {
      ...
      submit: "Send",
      note: "After pressing Send you can send your message with Gmail, Outlook or your email app.",
      readyTitle: "Your message is ready. How would you like to send it?",
      readyText: "It opens with the recipient, subject and message filled in; all you need to do is hit send.",
      viaGmail: "Open in Gmail",
      viaOutlook: "Open in Outlook",
      viaApp: "Email app",
      copy: "Copy message",
      copied: "Copied",
      copyHint: "If none of these open, copy the message and send it to:",
      sending: "Sending…",
      noteDirect: "Your message goes straight to our team; we'll reply to the email address you entered.",
      sentTitle: "Your message reached us.",
      sentText: "Thank you. We'll get back to you at the email address you entered as soon as we can.",
      sendAnother: "Write another message",
      sendError: "We couldn't send your message right now. You can send it one of the ways below; it's ready.",
      privacy: "The form is delivered via Web3Forms.",
      toLabel: "To",
      bodyName: "Name",
