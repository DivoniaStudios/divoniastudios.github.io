...
export const tr = {
  ...
  contactPage: {
    ...
    form: {
      ...
      noteDirect: "Mesajın doğrudan ekibimize iletilir; yanıtımız yazdığın e-posta adresine gelir.",
      sentTitle: "Mesajın bize ulaştı.",
      sentText: "Teşekkürler. En kısa sürede yazdığın e-posta adresine dönüş yapacağız.",
      sendAnother: "Yeni mesaj yaz",
      sendError: "Mesaj şu an gönderilemedi. Aşağıdaki yollardan biriyle gönderebilirsin; mesajın hazır.",
      privacy: "Form, Web3Forms aracılığıyla iletilir.",
      toLabel: "Kime",
      bodyName: "Ad",
      subjectLabel: "Konu",
